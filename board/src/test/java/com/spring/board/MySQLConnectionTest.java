...
public class MySQLConnectionTest {
    ...
    static final String URL = "jdbc:mysql://127.0.0.1:3306/board?allowPublicKeyRetrieval=true&serverTimezone=UTC&useSSL=false";
    static final String USERNAME = "board";
    static final String PASSWORD = "HappyDay19)%";
